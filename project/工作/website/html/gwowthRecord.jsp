...
<html>
    <head>
        ...
        <style type="text/css">
            .banner{
                background: url(${pageContext.request.contextPath}/website/images/xw_startour_growup_bg.png) no-repeat;
    ...
    <body class="bg-pale">
        ...
        <div class="growth-box position-offset w1100">
            ...
            <c:forEach items="${data.list}" var="item">
                ...
                <li>
                    <a class="clear" href="${pageContext.request.contextPath}/news/newRrowth?id=${item.id }">
                        <img class="fl" src="${item.newsPic }"/>
                        <h3>${item.title }</h3>
                        <p>${item.content }...</p>
                        <span class="news-time">2016年12月11日</span>
                    </a>
                </li>
