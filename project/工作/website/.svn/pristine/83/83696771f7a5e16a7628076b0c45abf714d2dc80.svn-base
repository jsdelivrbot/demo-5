...
<html>
    <head>
        ...
        <style type="text/css">
            .banner{
                background: url(${pageContext.request.contextPath}/website/images/xw_home_news_bg.jpg) no-repeat;
        ...
        <div class="banner second-banner">
            <div class="w1100">
                ...
                <ol class="breadcrumb w1100 clear">
                    ...
                    <li><a href="${pageContext.request.contextPath}/index">首页</a><i class="crumbIcon"></i></li>
                    <li>新闻资讯</li>
                </ol>
            </div>
        </div>
    ...
    genPageBar('${data.pageNum}',"${data.pages}",'laypage_12',function(data){
        window.location.href="indexlist?pageNum="+data;
    });
    </script>
</html>
