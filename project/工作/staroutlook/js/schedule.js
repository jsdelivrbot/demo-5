...
//									matchGroup = "2";      //组别
								...
								if(match.serverTime<match.startTime){
									...
									if(match.isReleaseScore !== "1"){//是否公布成绩
										...
										html += '<p class="promotion-status">已晋级<br />' + sumFraction + '</p><span class="supply-text">' + match.upgradeNotice + '</span>';
									}else{//未晋级
										
										html += '<p class="promotion-status">未晋级<br />' + sumFraction + '</p><span class="supply-text">' + match.notUpgradeNotice + '</span>';
